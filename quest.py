...
from selenium.webdriver.support.expected_conditions import visibility_of_element_located as ec_visible
...
def initialize_vars(driver) -> None:
    ...
    stam_bar = driver.execute_script("return document.querySelector('#stam_gage_num');")
